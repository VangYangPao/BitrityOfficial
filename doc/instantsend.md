...
This mechanism has been integrated into Bitcore-Node-Bitrity which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitritypay/insight-api-bitrity#web-socket-api](https://github.com/bitritypay/insight-api-bitrity#web-socket-api)
* API: [https://github.com/bitritypay/insight-api-bitrity#instantsend-transactions](https://github.com/bitritypay/insight-api-bitrity#instantsend-transactions)
...
By default, the Bitrity Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bitrity Core daemon:
