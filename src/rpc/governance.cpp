...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in bitrity.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("bitrity.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Bitrity features */
    { "bitrity",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "bitrity",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "bitrity",               "gobject",                &gobject,                true,  {} },
    { "bitrity",               "voteraw",                &voteraw,                true,  {} },
