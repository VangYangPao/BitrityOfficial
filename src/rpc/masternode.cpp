...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Bitrity address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "bitrity",               "masternode",             &masternode,             true,  {} },
    { "bitrity",               "masternodelist",         &masternodelist,         true,  {} },
    { "bitrity",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "bitrity",               "sentinelping",           &sentinelping,           true,  {} },
};
