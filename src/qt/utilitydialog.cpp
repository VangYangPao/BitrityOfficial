    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitrity-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bitrity in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BITY, 0.1 BITY, 1 BITY and 10 BITY -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bitritypay.atlassian.net/wiki/display/DOC/PrivateSend\">https://bitritypay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
