...
{
    const char* pszTimestamp = "Bitrity, from people to people";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // bitrity: 1 day
        consensus.nPowTargetSpacing = 120 ; // bitrity: 2.5 minutes
        ...
        vSeeds.push_back(CDNSSeedData("dnsseed.bitritycentral.org", "dnsseed.bitritycentral.org"));
        vSeeds.push_back(CDNSSeedData("dnsseed2.bitritycentral.org", "dnsseed2.bitritycentral.org"));
        vSeeds.push_back(CDNSSeedData("dnsseed3.bitritycentral.org", "dnsseed3.bitritycentral.org"));
        vSeeds.push_back(CDNSSeedData("bitrity.seeds.mn.zone", "bitrity.seeds.mn.zone"));
        vSeeds.push_back(CDNSSeedData("bitrity.mnseeds.com", "bitrity.mnseeds.com"));

        // bitrity addresses start with 'P'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,55);
        // bitrity script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,56);
        // bitrity private keys start with '3' or 'p'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,60);
        // bitrity BIP32 pubkeys start with 'ppub' (Bitrity Prefix)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x03)(0xE2)(0x5D)(0x7E).convert_to_container<std::vector<unsigned char> >();
        // bitrity BIP32 prvkeys start with 'pprv' (Bitrity Prefix)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x03)(0xE2)(0x59)(0x45).convert_to_container<std::vector<unsigned char> >();

        // bitrity BIP44 coin type is '5'
        nExtCoinType = 1997;
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 60 * 60 * 24; // bitrity: 1 day
        consensus.nPowTargetSpacing = 40; // bitrity: 2.5 minutes
        ...
        // Testnet bitrity addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet bitrity script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet bitrity BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet bitrity BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet bitrity BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CDevNetParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Bitrity: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Bitrity: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowKGWHeight = 4001; // nPowKGWHeight >= nPowDGWHeight means "no KGW"
        consensus.nPowDGWHeight = 4001;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("bitrityevo.org",  "devnet-seed.bitrityevo.org"));
...
public:
    CRegTestParams() {
      ...
      genesis = CreateGenesisBlock(1513831322, 887612, 0x1e0ffff0, 1, 50 * COIN);
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest bitrity script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest bitrity BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest bitrity BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest bitrity BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
