...
official/supported Docker Images found at https://hub.docker.com/r/bitritypay/bitrityd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/bitritypay/bitrityd-develop/ when changing the above text**