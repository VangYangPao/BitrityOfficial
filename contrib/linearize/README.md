# Linearize
Construct a linear, no-fork, best version of the Bitrity blockchain. The scripts
...
JSON-RPC server. Running `bitrityd` or `bitrity-qt -server` will be sufficient.
...
* `input`: bitrityd blocks/ directory containing blkNNNNN.dat
